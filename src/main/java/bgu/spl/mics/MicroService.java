...
public abstract class MicroService implements Runnable {
    ...
    private Hashtable<Class<? extends Message>, Callback> callbackTable;
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
        ...
        callbackTable.put(type, callback);
    }
    ...
    public final void run() {
        ...
        initialize();
        BookStoreRunner.initialService();

        while (!terminated) {
            try {

                Message currMessage = MessageBusImpl.getInstance().awaitMessage(this);

                callbackTable.get(currMessage.getClass()).call(currMessage);
